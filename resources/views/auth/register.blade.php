            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        {!! Form::hidden('codigo', '70123456AA') !!}
                        {!! Form::hidden('rol_id', 1) !!}
                        
                        <div class="row mb-3">
                            <label for="dni_ce" class="col-md-4 col-form-label text-md-end">{{ __('DNI/CE') }}</label>

                            <div class="col-md-6">
                                <input id="dni_ce" type="text" class="form-control @error('dni_ce') is-invalid @enderror" name="dni_ce" value="{{ old('dni_ce') }}" required autocomplete="dni_ce" autofocus>

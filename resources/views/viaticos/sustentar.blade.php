                ...
                <div class="p-3">
                    <div class="row align-items-center justify-content-center">
                        <div class="sidebar-brand-text m-3">
                            <h4 class="font-weight-bold">SUSTENTAR VIÁTICOS</h4>
                        </div>
    ...
    <div class="card bg-light shadow mx-auto p-4 h-auto"
        ...
        <div class="form-row m-2">
            <div class="form-group col-md-6 col-xs-12 mb-4">
                ...
                <h5 class="border-2">{{ $viatico->_proyecto->nombre_proyecto }}</h5>
            </div>
            <div class="form-group col-md-6 col-xs-12 mb-4">
                <label>AUTORIZADO POR:</label>
                <h5 class="border-2">{{ $viatico->_autorizado_por->nombres . ' ' . $viatico->_autorizado_por->apellidos }}
                </h5>
            </div>
            <div class="form-group col-md-6 col-xs-12 mb-4">
                <label>RESPONSABLE:</label>
                <h5 class="border-2">{{ $viatico->_responsable->nombres . ' ' . $viatico->_responsable->apellidos }}</h5>
            </div>
            <div class="form-group col-md-6 col-xs-12 mb-4">
                <label>MONTO:</label>
                <h5 class="border-2">{{ $viatico->monto }}</h5>
            </div>
        </div>
            ...
            <div class="form-row m-2">
                <div class="form-group col-12">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion"
                        rows="3" style="resize: none;">{{ $viatico->descripcion }}</textarea>
                </div>
                @error('descripcion')

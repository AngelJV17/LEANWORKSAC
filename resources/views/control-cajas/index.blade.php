                ...
                <div class="card w-50 bg-light shadow-lg bg-white mx-auto border-bottom-warning"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h5 class="card-title text-muted font-weight-bold">CAJA APERTURADA</h5>
                        </div>
                        <hr>
                        <p class="card-text  mb-4 text-muted">La caja está aperturada puedes realizar registros de
                            <strong>INGRESO</strong>
                            y <strong>EGRESO</strong>.
                        </p>
                        <div class="d-flex justify-content-end align-items-end">
                            <a href="#" type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                data-target="#formCaja">CERRAR CAJA</a>
                        </div>
                    </div>
                </div>
            </div>

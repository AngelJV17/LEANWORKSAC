...
@section('contenido')
                ...
                <div class="p-3">
                    <div class="row align-items-center justify-content-center">
                        <div class="sidebar-brand-text m-3">
                            <h4 class="font-weight-bold">REGISTRO DE CAJA CHICA</h4>
                        </div>
    ...
    <div class="card bg-light shadow mx-auto p-4 h-auto"
        ...
        <form action="{{ url('caja-chica') }}" method="POST">
            @csrf
                ...
                <div class="form-group col-lg-6 col-md-6 col-xs-6 mb-4">
                    ...
                    <select id="proyecto" name="proyecto" class="form-control @error('proyecto') is-invalid @enderror">
                        ...
                        @foreach ($proyectos as $proyecto)
                            <option class="text-uppercase" value="{{ $proyecto->id }}">{{ $proyecto->nombre_proyecto }}</option>
                        @endforeach
                    </select>
                    @error('proyecto')
            ...
            <div class="form-row m-2">
                <div class="form-group col-12">
                    ...
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" id="descripcion" name="descripcion" rows="3" style="resize: none;"></textarea>
                </div>
                @error('descripcion')
                    <div class="alert alert-danger m-2">{{ $message }}</div>
                @enderror
